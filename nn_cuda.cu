...
for (int i = 0; i < ITER; i++) {
  ...
  tv.tv_sec = tv_h2d_end.tv_sec - tv_h2d_start.tv_sec;
  tv.tv_usec = tv_h2d_end.tv_usec - tv_h2d_start.tv_usec;
  ...
  gettimeofday(&tv_kernel_start, NULL);
    ...
    tv.tv_sec = tv_kernel_end.tv_sec - tv_kernel_start.tv_sec;
    tv.tv_usec = tv_kernel_end.tv_usec - tv_kernel_start.tv_usec;
    ...
    tv.tv_sec = tv_d2h_end.tv_sec - tv_d2h_start.tv_sec;
    tv.tv_usec = tv_d2h_end.tv_usec - tv_d2h_start.tv_usec;
    findlowest_time += tv.tv_sec * 1000.0 + (float) tv.tv_usec / 1000.0;
#endif
    // print out results
    if (!quiet)
    ...
    h2d_time = h2d_time / ITER;
    d2h_time = d2h_time / ITER;
